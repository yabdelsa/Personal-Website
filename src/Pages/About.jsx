        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            >
              ...
              class of 2028. Passionate about building modern, functional, and
              user-friendly digital experiences. I focus on delivering the best
              solutions in every project I work on, combining clean code with
