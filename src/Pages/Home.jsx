...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 mt-1" data-aos="zoom-in" data-aos-delay="400">
...
const MainTitle = memo(() => (
  <div className="space-y-2 mt-4" data-aos="fade-up" data-aos-delay="600">
...
const SOCIAL_LINKS = [
  ...
  { icon: Instagram, link: "https://www.instagram.com/yahia_abdel06", label: "Instagram Profile" }
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Yahia Abdelsalam — Software Developer</title>
        <meta name="description" content="Official portfolio of Yahia Abdelsalam, Software Developer. Focused on creating attractive digital experiences and delivering the best solutions in every project." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://my-portfolio-7f5t.vercel.app" />
        <meta property="og:title" content="Yahia Abdelsalam — Software Developer" />
        <meta property="og:description" content="Official portfolio of Yahia Abdelsalam, Software Developer." />
        <meta property="og:url" content="https://my-portfolio-7f5t.vercel.app" />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "url": "https://my-portfolio-7f5t.vercel.app",
            "sameAs": [
              "https://github.com/yabdelsa",
              "http://www.linkedin.com/in/yabdelsa",  
              "https://www.instagram.com/yahia_abdel06"
            ]
          }
        `}</script>
      </Helmet>
