...
const techStacks = [
  ...
  { icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", language: "JavaScript" },
  ...
  { icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg", language: "ReactJS" },
];
...
export default function FullWidthTabs() {
  ...
  useEffect(() => {
    ...
    if (cachedProjects && cachedCertificates) {
      ...
      // Only use cache if it has lowercase keys (new format)
