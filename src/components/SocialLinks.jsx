...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "http://www.linkedin.com/in/yabdelsa",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@yahia_abdel06",
    icon: Instagram,
    url: "https://www.instagram.com/yahia_abdel06",
    color: "#E4405F",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        <a href={linkedIn.url} target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-between p-4 rounded-lg bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500" data-aos="fade-up" data-aos-delay="100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[instagram, github].map((link, index) => (
            <a key={link.name} href={link.url} target="_blank" rel="noopener noreferrer" className="group relative flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/10 overflow-hidden hover:border-white/20 transition-all duration-500" data-aos="fade-up" data-aos-delay={200 + index * 100}>
